...
@Composable
fun LoginDriver(modifier: Modifier=Modifier, navController: NavController, authViewModel: authViewModel){
    ...
    LaunchedEffect(authState.value) {
        when (authState.value) {
            is AuthState.Authenticated -> navController.navigate("dashDriver")
    ...
    Column(modifier= Modifier.fillMaxSize(),
        ...
        Row (horizontalArrangement = Arrangement.Center){
            ...
            TextButton(onClick = { navController.navigate("signupDriver")}) {
                Text(text = "Sign UP")
            }
        }
